(function () {
    ...
    // --- Flood Fill ---
    function floodFill(x, y, tolerance = 15) {
        const imgCanvas = document.createElement('canvas');
        imgCanvas.width = maskCanvas.width; imgCanvas.height = maskCanvas.height;
        ...
        while (queue.length > 0) {
            ...
            const idx = cy * imgCanvas.width + cx; if (visited[idx]) continue;
            visited[idx] = 1;
